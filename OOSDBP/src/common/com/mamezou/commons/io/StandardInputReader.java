 ...
 * 使用例 :
 * <code>String stringData = StandardInputReader.getInputString("文字列を入力してください：");</code>
 * <br>
 * <br>
 * <b>整数の数値データを取得する場合 {@link #getInputInt(String)} メソッドを使用します</b><br>
 * 使用例 : <code>int intData = StandardInputReader.getInputInt("数値を入力してください："); </code>
 * <br>
 * <br>
 * <b>小数の数値データを取得する場合 {@link #getInputDouble(String)} メソッドを使用します</b><br>
 * 使用例 : <code>double doubleData = StandardInputReader.getInputDouble("数値を入力してください："); </code>
 */
public class StandardInputReader {
     ...
     *             int型に変換できない値(アルファベット、long型の範囲の整数、小数など)が入力された場合
     */
     ...
     * @throws NumberFormatException
     *             double型に変換できない値(アルファベットなど)が入力された場合
     */
